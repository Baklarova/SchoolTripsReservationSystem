...
namespace SchoolTripsReservationSystem.Infrastructure.Migrations
{
    ...
    [Migration("20240417112911_IsApprovedAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolTripsReservationSystem.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1d48965f-80f2-40a0-ae02-686ad3c5c83a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEORhfogTDDn6m8jniiELfEXjUgsGi+ix/HZIjZ+YDYspnrD7UrJflvQICjUBJGbioQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d628c301-08a0-499d-a215-71c4eaa7b8eb",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2c8a9efe-b1d4-4754-be71-5c899abeda77",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBHJ7qrjrSY31BOmvDz784a/pdE7JBwq+8MfJ8QOCYN+jnp+KQDMEazRkq7banTyGQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a71ed6bc-7afc-4da3-963e-d095b3ef15f6",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SchoolTripsReservationSystem.Infrastructure.Data.Models.Reservation", b =>
                {
                    ...
                    b.Property<bool>("IsApproved")
                        .HasColumnType("bit")
                        .HasComment("Is reservation approved by administrator");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SchoolTripsReservationSystem.Infrastructure.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolTripsReservationSystem.Infrastructure.Data.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("SchoolTripsReservationSystem.Infrastructure.Data.Models.ApplicationUser", "GroupLeader")
                        .WithMany()
